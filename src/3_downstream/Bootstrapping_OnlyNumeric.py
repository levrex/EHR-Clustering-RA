...
PROJECTION_DATA = 'MMAE_clustering_200_NUMERIC'
...
Z = pd.read_csv('/exports/reum/tdmaarseveen/RA_Clustering/new_data/5_clustering/df_lab_scaled_demographics.csv', sep=',')[['Leuko', 'MCH', 'Hb', 'Ht', 'MCHC',  'MCV', 'Trom', 'BSE', 'Age']]
...
df_meta = pd.read_csv('/exports/reum/tdmaarseveen/RA_Clustering/new_data/offshoots/df_ehr_DAS.csv', sep='|')
...
func.visualize_umap_bokeh_na_2(fit1, metadata[l_final_col], list(l_final_col), l_binary=l_cat, patient_id='sample', cluster_id='PhenoGraph_clusters', title='MAUI_PHENOGRAPH_190_NUMERIC_STABILITY_TSNE')
func.visualize_umap_bokeh_na_2(fit2, metadata[l_final_col], list(l_final_col), l_binary=l_cat, patient_id='sample', cluster_id='PhenoGraph_clusters', title='MAUI_PHENOGRAPH_190_NUMERIC_STABILITY_UMAP')
...
plt.savefig("/exports/reum/tdmaarseveen/RA_Clustering/figures/3_clustering/heatmap_unsorted_NUMERIC.png") 
