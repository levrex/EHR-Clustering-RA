...
knitr::opts_knit$set(root.dir = "/exports/reum/tdmaarseveen/EHR-Clustering-RA")

# Set library folder
.libPaths("/exports/reum/tdmaarseveen/Rlibs")
remove.packages("rlang", lib.loc = .libPaths()[x])

setwd("/exports/reum/tdmaarseveen/EHR-Clustering-RA")
getwd()
```
...
df_survival <- as.data.frame(read_csv("new_data/5_clustering/df_survivaldata_mmae.csv", col_types = cols(...1 = col_skip())))
head(df_survival)
```
